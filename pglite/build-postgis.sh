...
emmake make LDFLAGS_SL="-sWASM_BIGINT -L/install/libs/lib -lpgport -lpgcommon -sSIDE_MODULE=1 -fexceptions" CFLAGS_SL="-fexceptions -sWASM_BIGINT" CXXFLAGS="-fexceptions -sWASM_BIGINT" -j
