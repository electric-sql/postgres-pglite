...
if (!outputPath) {
  throw new Error('usage: phase8-scope-hierarchy.mjs WASM GLUE DATA OUTPUT')
}
  ...
  `${JSON.stringify(
    {
      schema: 1,
      status: 'pass',
      profile: 'hierarchical-root-scoped-memory',
      generationReuse: true,
...
postgres.FS.quit()
console.log('Phase 8 hierarchical scope artifact gate: PASS')
