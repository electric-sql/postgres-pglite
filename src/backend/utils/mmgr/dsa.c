...
#ifdef __PGLITE_POSTMASTER__
	pgl_scope_handle = dsm_segment_scope_handle(segment);
#endif
...
#ifdef __PGLITE_POSTMASTER__
	control->pgl_scope_handle = pgl_scope_handle;
#else
	(void) pgl_scope_handle;
#endif
